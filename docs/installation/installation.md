...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v0.8.5/milvus-operator-0.8.5.tgz
```
...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v0.8.5/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v0.8.5/deploy/manifests/deployment.yaml
```
