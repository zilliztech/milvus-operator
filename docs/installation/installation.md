...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v1.3.4/milvus-operator-1.3.4.tgz
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/zilliztech/milvus-operator/v1.3.4/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://raw.githubusercontent.com/zilliztech/milvus-operator/v1.3.4/deploy/manifests/deployment.yaml
```
