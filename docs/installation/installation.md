...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v0.9.4/milvus-operator-0.9.4.tgz
```
...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v0.9.4/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v0.9.4/deploy/manifests/deployment.yaml
```
