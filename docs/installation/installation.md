...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v0.8.1/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v0.8.1/deploy/manifests/deployment.yaml
```
