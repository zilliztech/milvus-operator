...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v1.1.0/milvus-operator-1.1.0.tgz
```
...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v1.1.0/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v1.1.0/deploy/manifests/deployment.yaml
```
