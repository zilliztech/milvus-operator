...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v1.0.8/milvus-operator-1.0.8.tgz
```
...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v1.0.8/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v1.0.8/deploy/manifests/deployment.yaml
```
