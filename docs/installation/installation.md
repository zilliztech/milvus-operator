...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v1.0.3/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v1.0.3/deploy/manifests/deployment.yaml
```
