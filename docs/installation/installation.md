...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v1.1.1/milvus-operator-1.1.1.tgz
```
...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v1.1.1/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v1.1.1/deploy/manifests/deployment.yaml
```
