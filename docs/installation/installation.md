...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v0.8.6/milvus-operator-0.8.6.tgz
```
...
```shell
kubectl apply -f https://github.com/zilliztech/milvus-operator/v0.8.6/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://github.com/zilliztech/milvus-operator/v0.8.6/deploy/manifests/deployment.yaml
```
