...
helm install milvus-operator \
  ...
  https://github.com/zilliztech/milvus-operator/releases/download/v1.2.5/milvus-operator-1.2.5.tgz
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/zilliztech/milvus-operator/v1.2.5/deploy/manifests/deployment.yaml
``` 
...
```shell
kubectl delete -f https://raw.githubusercontent.com/zilliztech/milvus-operator/v1.2.5/deploy/manifests/deployment.yaml
```
