...
// Add a new method to explicitly use appsv1.StatefulSet
func (l *LocalHelmReconciler) getStatefulSet(ctx context.Context, namespace, name string) (*appsv1.StatefulSet, error) {
	return l.clientset.AppsV1().StatefulSets(namespace).Get(ctx, name, metav1.GetOptions{})
}
