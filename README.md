...
```shell
kubectl apply -f https://raw.githubusercontent.com/zilliztech/milvus-operator/v0.8.5/deploy/manifests/deployment.yaml
```
...
Versions, v2.3.3 `[1]`, 2.8.2 / 3.1.0, 3.5.5-2, RELEASE.2023-03-20T20-16-18Z -->
