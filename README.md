...
```shell
kubectl apply -f https://raw.githubusercontent.com/zilliztech/milvus-operator/v1.1.1/deploy/manifests/deployment.yaml
```
...
Versions, v2.4.13-hotfix `[1]`, 2.9.5 / 3.1.0, 3.5.14, RELEASE.2023-03-20T20-16-18Z -->

|Components| Milvus| Pulsar / Kafka| Etcd| MinIO|
|---|---|---|---|---|
|Versions| v2.4.13-hotfix `[1]`| 2.9.5`[2]` / 3.1.0 | 3.5.14 |RELEASE.2023-03-20T20-16-18Z|
